...
/*     */
{
	...
	/*     */
	{
		...
		/*     */try
		/*     */{
			/* 26 */if (BasicStringUtil.isNotNullString(paramString1, paramString2,
					paramString3))
			/*     */
			{
				/* 30 */if (!BasicFileUtil
				...
				/*     */
				{
					/* 32 */str2 = BasicFileUtil.removeLastSplit(System
				...
				/*     */
				{
					...
					/*     */
					/* 45 */localRandomAccessFile.writeBytes(BasicStringUtil
							.GBK2ISO(str1));
	...
	/*     */
	{
		...
		/*     */try
		/*     */{
			/* 112 */if (BasicStringUtil.isNotNullString(paramString1, paramString2,
					paramString3))
			/*     */
			{
				...
				/*     */
				{
					/* 118 */str2 = BasicFileUtil.removeLastSplit(System
							.getProperty("java.home"));
					/*     */}
				/*     */
				...
				/*     */
				{
					...
					/*     */
					/* 131 */localRandomAccessFile.writeBytes(BasicStringUtil
							.GBK2ISO(str1));
	...
	/*     */
	{
		...
		/*     */try
		/*     */{
			/* 69 */if (BasicStringUtil.isNotNullString(paramString1, paramString2,
					paramString3))
			/*     */
			{
				/* 73 */if (!BasicFileUtil
				...
				/*     */
				{
					/* 75 */str2 = BasicFileUtil.removeLastSplit(System
							.getProperty("java.home"));
					/*     */}
				/*     */
				...
				/*     */
				{
					...
					/*     */
					/* 88 */localRandomAccessFile.writeBytes(BasicStringUtil
							.GBK2ISO(str1));
